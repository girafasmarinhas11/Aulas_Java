...
public class Desafio03 {
    ...
    static File arquivoBancoDeDados = new File(System.getProperty("user.home"), "bancoDeDodos.txt");
    ...
    public static void  deletarUsuario(){
        ...
        for (int linhas = 1, idNovaMatriz = 1 ; linhas < matrizCadastro.length; linhas++){
            if(linhas == idEscolha){
                continue;
            }
            novaMatriz[linhas] = Arrays.copyOf(matrizCadastro[linhas], matrizCadastro[linhas].length);
